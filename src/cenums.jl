...
@cenum EnumerateFlags::UInt32 begin
...
@cenum EncodeStatus::UInt32 begin
...
@cenum MvcmdStatus::UInt32 begin
...
@cenum MoveFlags::UInt32 begin
	RPM_DIV_1000    = 0x01
end

@cenum EngineFlags::UInt32 begin
	ENGINE_REVERSE           = 0x01
...
@cenum MicrostepMode::UInt32 begin
...
@cenum PositionFlags::UInt32 begin
	SETPOS_IGNORE_POSITION    = 0x01
	SETPOS_IGNORE_ENCODER     = 0x02
end

@cenum FeedbackType::UInt32 begin
...
@cenum FeedbackFlags::UInt32 begin
...
@cenum SyncInFlags::UInt32 begin
	SYNCIN_ENABLED         = 0x01
	SYNCIN_INVERT          = 0x02
	SYNCIN_GOTOPOSITION    = 0x04
end

@cenum SyncOutFlags::UInt32 begin
...
@cenum ExtioSetupFlags::UInt32 begin
	EXTIO_SETUP_OUTPUT    = 0x01
	EXTIO_SETUP_INVERT    = 0x02
end

@cenum ExtioModeFlags::UInt32 begin
...
@cenum BorderFlags::UInt32 begin
...
@cenum EnderFlags::UInt32 begin
	ENDER_SWAP              = 0x01
	ENDER_SW1_ACTIVE_LOW    = 0x02
	ENDER_SW2_ACTIVE_LOW    = 0x04
end

@cenum BrakeFlags::UInt32 begin
	BRAKE_ENABLED       = 0x01
	BRAKE_ENG_PWROFF    = 0x02
end

@cenum ControlFlags::UInt32 begin
...
@cenum JoyFlags::UInt32 begin
	JOY_REVERSE    = 0x01
end

@cenum CtpFlags::UInt32 begin
	CTP_ENABLED             = 0x01
	CTP_BASE                = 0x02
...
@cenum UARTSetupFlags::UInt32 begin
...
@cenum MotorTypeFlags::UInt32 begin
...
@cenum EncoderSettingsFlags::UInt32 begin
...
@cenum MBSettingsFlags::UInt32 begin
	MB_AVAILABLE       = 0x01
	MB_POWERED_HOLD    = 0x02
end

@cenum TSSettingsFlags::UInt32 begin
	TS_TYPE_BITS             = 0x07
...
@cenum BackEMFFlags::UInt32 begin
